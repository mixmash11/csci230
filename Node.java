...
public class Node {
    ...
    public void addCList( Node node ) {
        collisionList.add( node );
    }

    public void setCList( List collisionList ) {
        this.collisionList = collisionList;
    }

    public void removeCList( int index ) throws OutOfBoundsException {
        collisionList.remove( index );
    }

    public Node retrieveCList( int index ) throws OutOfBoundsException {
        return collisionList.retrieve( index );
    }

    public boolean hasCList() {
    ...
    public boolean hasAdjacentNode( int data ) {
        ...
        for ( int i = 0 ; i < adjacentNodes.size() ; i ++ ) {
            ...
            try {
                ...
                if ( adjacentNodes.getData( i ) == data ) {
                    return found;
                }
    ...
    public int getAdjacentNodeIndex( int val ) {
        ...
        for ( int i = 0 ; i < adjacentNodes.size() ; i ++ ) {
            ...
            try {
                ...
                if ( adjacentNodes.getData( i ) == val ) {
                    return i;
                }
